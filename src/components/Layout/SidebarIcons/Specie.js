...
export const Specie = ({ size = 18, ...rest }) => {
    return (
        <svg fill="#FEB45F" xmlns="http://www.w3.org/2000/svg" 
	 width="18" height="18" viewBox="0 0 100 100" enable-background="new 0 0 100 100">
<g>
